...
export default function CurrencyConverter({ toData, fromData, isLoading, currencyList, countryOptions, handleCurrencySwap, handleCurrencyChanged, handleCurrencyConversion }) {
    useEffect(() => {
        // axios
        //     .get("/api/currency")
        //     .then((users) => console.log("currency>> ", users))
        //     .catch((err) => console.log(err));
        console.log("currencyList", currencyList);
        console.log("countryOptions", countryOptions);
        console.log("countryOptions", fromData);
    }, [currencyList]);
    return (
        <div className="main">
